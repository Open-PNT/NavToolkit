...
DemoStandardEkf::DemoStandardEkf(int test_num) {
	out          = zeros(1, ekf_test.test_size(test_num));
	outP         = zeros(1, ekf_test.test_size(test_num));
	truth        = zeros(1, ekf_test.test_size(test_num));
	measurements = zeros(1, ekf_test.test_size(test_num) / 10);

	vector<double> tmp_truth        = ekf_test.truth(test_num);
	vector<double> tmp_measurements = ekf_test.measurements(test_num);
