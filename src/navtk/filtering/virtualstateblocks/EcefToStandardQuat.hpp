...
/**
 * VirtualStateBlock representing an N-state 'Standard' PVA, constructed from an
 * ECEF-with-quaternion PVA. 'Standard' here refers to position represented as
 ...
 */
class EcefToStandardQuat : public VirtualStateBlock {
public:
	/**
	 * Constructor.
	 ...
	 */
	EcefToStandardQuat(std::string current, std::string target);
